...
export default async function VaptPage() {
  ...
  const sections: Section[] = data.pageItemdataWithSubsection || [];
  ...
  return (
    <>
      <section
        ...
        <div className="auto-container about_title">
          <h1>
            {page?.title || "Vulnerability Assessment and Penetration Testing"}
          </h1>
          <span className="title_divider"></span>
        </div>
      </section>
        ...
        <section className="case-study-section zero_ser soc_item vapt_box">
          <div className="auto-container">
            <div className="sec-title text-center">
              ...
              <div className="text soc_text">
                {parse(mainSection.shortDescription || "")}
              </div>
            </div>

            {mainSection.subsections && mainSection.subsections.length > 0 && (
              <div className="row">
                {mainSection.subsections.map(
                  (subsection: Subsection, index: number) => (
                    <div
                      key={subsection.id}
                        ...
                        <div className="image-box">
                          <figure className="image">
                            <a href="#">
                              <Image
                                src={
                                  subsection.image || "/images/placeholder.jpg"
                                }
            ...
            {bottomSection && (
              <div className="row mt-5">
                <div className="col-md-8" data-aos="fade-right">
                  <div className="soc_section">
                    {parse(bottomSection.shortDescription || "")}
                  </div>
                </div>
                <div className="col-md-4" data-aos="fade-left">
                  <div className="soc_img">
                    {bottomSection.image && (
                      <Image
                        src={bottomSection.image}
                        alt={bottomSection.title}
=======
      {/* Case Study Section */}
      <section className="case-study-section zero_ser soc_item vapt_box" style={{ overflowX: "hidden" }}>
        <div className="auto-container">
          <div className="sec-title text-center">
            <h3>Vulnerability Assessment and Penetration Testing</h3>
            <div className="text soc_text">
